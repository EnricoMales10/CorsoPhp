-- Active: 1677862080074@@127.0.0.1@3306@form_in_php
-- phpMyAdmin SQL Dump
-- version 5.2.0
-- https://www.phpmyadmin.net/
--
-- Host: 127.0.0.1
-- Creato il: Mar 17, 2023 alle 14:34
...
(1, 'Mario', 'Rossi', '2023-03-15', 'Torino', 12, 96, 'M', 'mariorossi@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99');
...
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `provincia_ibfk_1` FOREIGN KEY (`regione_id`) REFERENCES `regione` (`regione_id`);
COMMIT;
